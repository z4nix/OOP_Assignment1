...
class RegressionPlotter:
    ...
    def plotND(self) -> None:
        for i in range(self._featureNumber):
            plt.figure()
            ...
            x_modified = np.full((100, self._featureNumber), self.x.mean(axis=0))
    ...
    def plot(self):
        ...
        self._featureNumber = self.x.shape[1]

        if self._featureNumber == 2:
